...
const Appointment = () => {
  ...
  return (
    docInfo && (
      <div>
        {/* Doctor Details */}
        <div className="flex flexcol sm:flex-row gap-4">
          <div>
            <img
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <h3 className="flex items-center gap-2 text-2xl font-medium text-gray-900">
              {docInfo.name}
              <img className="w-5" src={fr_assets.verified_icon} alt="" />
            </h3>
            ...
            <div>
              <p className="flex items-center gap-1 text-sm font-medium text-gray-900 mt-3">
                About <img src={fr_assets.info_icon} alt="" />
              </p>
